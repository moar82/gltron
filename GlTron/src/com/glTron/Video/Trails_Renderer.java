...
public class Trails_Renderer {
	...
	{
		gl = gl_in;
		Trails = new GLTexture(new GLTextureParameter(gl, context, R.drawable.gltron_traildecal,
...
//		gl.glColor4f(0.0f, 0.0f, 0.0f, 0.4f);
	...
	public void drawTrailLines(DrawTrailLinesParameter parameterObject)
	{
		...
		for(segOffset = 0; segOffset <= parameterObject.trail_offset; segOffset++)
		{
			...
			float tempvertex[] =
			{
				parameterObject.segs[segOffset].vStart.v[0], 
				parameterObject.segs[segOffset].vStart.v[1], 
				parameterObject.trail_height,
				
				parameterObject.segs[segOffset].vStart.v[0] + parameterObject.segs[segOffset].vDirection.v[0],
				parameterObject.segs[segOffset].vStart.v[1] + parameterObject.segs[segOffset].vDirection.v[1],
				parameterObject.trail_height
			};
