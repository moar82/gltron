...
public class GLTexture {
	...
	public GLTexture(GLTextureParameter parameterObject)
	{
		WrapS = parameterObject.wrap_s;
		WrapT = parameterObject.wrap_t;
		_texID = new int[1];
		loadTexture(parameterObject.gl,parameterObject.context,parameterObject.resource);
	}
	
	public GLTexture(GLTextureParameter parameterObject, boolean mipMap)
	{
		WrapS = parameterObject.wrap_s;
		WrapT = parameterObject.wrap_t;
		boGenMipMap = mipMap;
