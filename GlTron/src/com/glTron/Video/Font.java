...
public class Font {
	...
	{
		gl = gl1;
		Tex1 = new GLTexture(new GLTextureParameter(gl,context,tex1,GL10.GL_CLAMP_TO_EDGE,GL10.GL_CLAMP_TO_EDGE),false);
		Tex2 = new GLTexture(new GLTextureParameter(gl,context,tex2,GL10.GL_CLAMP_TO_EDGE,GL10.GL_CLAMP_TO_EDGE),false);
		//_nTextures = 2;
	}
