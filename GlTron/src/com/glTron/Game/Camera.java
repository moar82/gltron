...
import com.glTron.Video.DrawTrailLinesParameter;
import com.glTron.Video.GraphicUtils;
import com.glTron.Video.TrailMesh;
...
public class Camera {
	...
	public void drawTrails(Trails_Renderer render, Player player)
	{
		if(player.trailHeight > 0.0f)
		{
			player.Trailmesh = new TrailMesh(player);
			render.Render(player.Trailmesh);
			player.Trailmesh = null;
			render.drawTrailLines(new DrawTrailLinesParameter(player.Trails, player.trailOffset,
					player.trailHeight, this));
		}
	}
